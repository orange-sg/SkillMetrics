...
def taylor_diagram(*args, **kwargs):
    ...
    nargin = len(args)
    STDs, RMSs, CORs, PPAXS = _get_taylor_diagram_arguments(*args,**kwargs)
    if nargin == 0: return
    ...
    axes, cax = get_taylor_diagram_axes(rho,AXP,option)
